...
/*
* This calss defines a new type of Layer for Interoperability personalization
...
export class InteroperabilityLayer extends tf.layers.Layer {
     ...
     */
    build() {
      this.weight = this.addWeight('weight', [this.units], 'float32', tf.initializers.ones());
    ...
    getConfig() {
      ...
      Object.assign(config, {units: this.units, inputShape: this.inputShape, weight: this.weight, bias: this.bias});
      return config;
    }
