...
export default {
  ...
  methods: {
    async saveModelButton(savePersonalModel = false) {
    ...
    async joinTraining(distributed, interoperability = false) {
      ...
      if (nbrFiles == 0) {
        ...
        reader.onload = async e => {
          ...
          var processedDataset = await this.Task.dataPreprocessing(
            e,
            this.headers
          );
          ...
          await this.trainingManager.trainModel(processedDataset, distributed, interoperability);
