<template>
  <div>
    ...
    <!-- If we are using Interoperability Personalization, display the heatmap of the weight and biases -->
    <div v-if="displayHeatmap" class="grid grid-cols-1 p-4 space-y-8 lg:gap-8">
      <div class="col-span-1 bg-white rounded-lg dark:bg-darker">
        <div
          class="flex items-center justify-between p-4 border-b dark:border-primary"
        >
